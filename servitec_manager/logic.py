...
class GESTOR_REPORTES:
    ...
    def OBTENER_HISTORIAL_COMPLETO_ORDENES(self):
        return self.bd.OBTENER_TODOS("""
            SELECT o.id, o.fecha, c.nombre AS cliente_nombre, o.equipo || ' ' || o.modelo AS equipo_completo, u.nombre AS tecnico_nombre, o.estado, o.condicion, o.presupuesto, f.fecha_cierre
            FROM ORDENES o
